-- Update the check constraint to include all current types plus 'No Show'
...
CHECK (type IN ('attendance', 'participation', 'bonus', 'penalty', 'Attendance', 'Star Speaker', 'Best Speaker', 'Critical Thinker', 'Referral', 'No Show', 'Moderator'));
